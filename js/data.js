/* ==========================================================================
   Teachers' Day — Content Engine (generated from staff.csv)
   --------------------------------------------------------------------------
   Every staff member of the school lives in SITE_DATA.teachers below.
   Photos: each record points at images/<file> from the CSV — drop the real
   photos into the images/ folder and they appear automatically. Until then
   the site uses the initial avatars in assets/staff-avatars/.
   ========================================================================== */
window.SITE_DATA = {
  "teachers": [
    {
    ...
    },
    {
      ...
      "title": "Sir",
      "designation": "P.G.T.",
      "group": "P.G.T. (Senior Teachers)",
      "qualification": "M.Com., B.Ed.",
      "subjectRaw": "Business,Accounts",
      "subject": "default",
    ...
    },
    {
      ...
      "designation": "P.G.T.",
      "group": "P.G.T. (Senior Teachers)",
      "qualification": "M.Sc.,B.Ed.,M.Phil.,M.A.",
      "subjectRaw": "Mathematics,U.G.C NET",
      "subject": "maths",
    ...
    },
    {
      ...
      "designation": "P.G.T.",
      "group": "P.G.T. (Senior Teachers)",
      "qualification": "B.A(English-Honours)M.A.",
      "subjectRaw": "(English,Sociology,Education)B.Ed",
      "subject": "english",
    ...
    },
    {
      "id": "p015",
      "num": 15,
      "name": "Edna R. Theophilus",
      "shortName": "Edna",
      "title": "Ma'am",
      "designation": "T.G.T.",
      "group": "T.G.T. (Middle School)",
      "qualification": "M.A., B.Ed.",
      "subjectRaw": "Social Studies",
      "subject": "social",
    ...
    },
    {
      ...
      "group": "T.G.T. (Middle School)",
      "qualification": "M.Com., B.Ed.",
      "subjectRaw": "Mathematics,Economics",
      "subject": "maths",
    ...
    },
    {
      ...
      "group": "T.G.T. (Middle School)",
      "qualification": "B.Sc., B.Ed.",
      "subjectRaw": "M.A., M.Sc(Maths), B.Ed.",
      "subject": "maths",
    ...
    },
    {
      "id": "p028",
      "num": 28,
      "name": "Henrietta Raj Antony",
      "shortName": "Henrietta",
      "title": "Ma'am",
      "designation": "P.R.T.",
      "group": "P.R.T. (Primary)",
      "qualification": "B.Sc,B.Ed,CTET",
      "subjectRaw": "",
      "subject": "default",
    ...
    },
    {
      "id": "p032",
      "num": 32,
      "name": "Madhu Malini Agarwal",
      "shortName": "Madhu",
      "title": "Ma'am",
      "designation": "P.R.T.",
      "group": "P.R.T. (Primary)",
      "qualification": "M.Com,B.Ed,CTET",
      "subjectRaw": "",
      "subject": "default",
    ...
    },
    {
      "id": "p044",
      "num": 44,
      "name": "Lalit Kumar Rai",
      "shortName": "Lalit",
      "title": "Sir",
      "designation": "P.R.T.",
      "group": "P.R.T. (Primary)",
      "qualification": "Inter, Music Prabhakar",
      "subjectRaw": "",
      "subject": "music",
    ...
    },
    {
      ...
      "designation": "P.R.T.",
      "group": "P.R.T. (Primary)",
      "qualification": "B.Ed, M.A (ENG & ECO)",
      "subjectRaw": "",
      "subject": "default",
    ...
    },
    {
      ...
      "group": "Office Staff",
      "qualification": "B.Com",
      "subjectRaw": "Superintendent, Sr. Acc.",
      "subject": "default",
    ...
    },
    {
      ...
      "designation": "Office Staff",
      "group": "Office Staff",
      "qualification": "Secretarial Diploma",
      "subjectRaw": "Clerk",
      "subject": "default",
    ...
    },
    {
      ...
      "group": "Supporting Staff",
      "qualification": "IV Class Staff",
      "subjectRaw": "",
      "subject": "default",
  ...
  "quotes": [
    ...
    {
      "text": "One book, one pen, one child, and one teacher can change the world.",
      "who": "Malala Yousafzai"
    },
    {
      "text": "Everyone who remembers his own education remembers teachers, not methods.",
      "who": "Sidney Hook"
    },
    {
    ...
    {
      "text": "In a world where you can be anything, be kind. Teachers chose kind first.",
      "who": "Pavit Singh"
    }
  ],
  "wishNotes": [
    ...
    {
      "note": "Teachers plant seeds that grow forever. Thank you for ours.",
      "by": "Pavit Singh"
    },
    {
  ...
  "wallNotes": [
    {
      "note": "To every teacher and staff member who makes our school feel like home — thank you.",
      "by": "Pavit Singh"
    },
    {
      "note": "The way you explain things twice without sighing should be studied by scientists.",
      "by": "Pavit Singh"
    },
    {
      "note": "Our school is basically a family now — and it's because of how you treat us.",
      "by": "Pavit Singh"
    },
    {
      "note": "Thank you for staying after the bell when you didn't have to. I noticed, always.",
      "by": "Pavit Singh"
    },
    {
      "note": "You celebrate my small wins like they're world records. I love you for it.",
      "by": "Pavit Singh"
    },
    {
      "note": "Your 'you can do this' is the strongest sentence in the English language.",
      "by": "Pavit Singh"
    },
    {
      "note": "Thank you for the work you do at St. Mary's Academy — even for students who are not in your class.",
    ...
    {
      "note": "Best. Staff. Ever. There is no debate and there never will be.",
      "by": "Pavit Singh"
    },
    {
      "note": "Every corridor, every class, every office — full of people who shaped me. Thank you all.",
      "by": "Pavit Singh"
    },
    {
      "note": "You made the hardest days at school feel a little lighter. Grateful for you.",
      "by": "Pavit Singh"
    },
    {
      "note": "Happy Teachers' Day to the people who shaped me — every single one of you. 💛",
      "by": "Pavit Singh"
    }
  ],
  "dailyWishes": [
    "Dear teachers, may this week begin the way you make every class begin — with a smile. 💛",
    "Somewhere a teacher is explaining something for the third time with endless patience. I salute you. 🫡",
    "Halfway through the week and you're still the best part of my school days. 🌟",
    "Thank you for turning 'I can't' into 'I'll try' — one lesson at a time. 💪",
    "You made it to Friday, and so did I — thanks to you. 🎉",
    "Even on weekends, I carry your lessons with me. That's how powerful you are. 📚",
