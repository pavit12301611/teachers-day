...
python3 tools/build_staff_pdf.py        # regenerates the whole PDF from the data in this repo
python3 tools/build_staff_pdf.py --dpi 300 --quality 88 --out /tmp/big.pdf   # print-shop quality
```
